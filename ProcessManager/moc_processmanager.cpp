...
QT_MOC_LITERAL(1, 15, 15), // "cpuUsageChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 11) // "getCpuUsage"

    },
    "ProcessManager\0cpuUsageChanged\0\0"
    "getCpuUsage"
};
...
void ProcessManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { double _r = _t->getCpuUsage();
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessManager::cpuUsageChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ProcessManager::cpuUsageChanged()
{
